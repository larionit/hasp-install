...
target_script_url=https://raw.githubusercontent.com/larionit/hasp-install/dev/ru/hasp-install.sh

# Link to this installation script (needed in case of privilege escalation via sudo)
setup_script_url=https://raw.githubusercontent.com/larionit/hasp-install/dev/ru/setup.sh
